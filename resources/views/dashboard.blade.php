...
<div class="layout-wrapper layout-content-navbar">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <a href="index.html" class="app-brand-link">
            ...
            <span class="-text demo menu-text fw-bolder ms-2">MEMITS</span>
        </a>
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Vacations</span>
            </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-user"></i>
            <div data-i18n="Layouts">My Vacations</div>
            </a>

            <ul class="menu-sub">

            <li class="menu-item">
                <a href="offdays" class="menu-link">
                <div data-i18n="Without navbar">Request Vacation</div>
        ...
        {{-- Donations --}}
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Birthdays</span>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons bx bx-dock-top"></i>
            <div data-i18n="Account Settings">Colleagues birthdays</div>
            </a>
            <ul class="menu-sub">
            <li class="menu-item">
